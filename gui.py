...
from modules.payloads.reverse.reverse_tcp import handle_download, handle_upload, send_command_to_session
...
class LazyFrameworkGUI(QMainWindow):
    ...
    def set_dark_theme(self):
        ...
        self.setStyleSheet("""
            ...
            /* SESSION OUTPUT - DARK MODE */
            QTextEdit#session_output {
                background: #1e1e1e;
                color: #50fa7b;
            ...
            /* SESSION COMMAND INPUT - DARK MODE */
            QLineEdit#session_cmd_input {
                background: #252525;
                color: #ffffff;
                border: 1px solid #404040;
                border-radius: 4px;
            ...
            QPushButton#session_button:hover {
                background: #3d3d3d;
            }
    ...
    def set_light_theme(self):
        ...
        self.setStyleSheet("""
            ...
            /* SESSION COMMAND INPUT - LIGHT MODE */
            QLineEdit#session_cmd_input {
                background: white;
                color: #2c3e50;
                border: 1px solid #bdc3c7;
    ...
    def create_main_content(self):
        ...
        cmd_layout.addWidget(self.upload_btn)
        cmd_layout.addWidget(self.download_btn)
    ...
    def run_module(self):
        ...
        for name, widget in self.option_widgets.items():
         ...
         # === CRITICAL: SETUP SESSION SYNC SEBELUM MODULE RUN ===
