...
class LazyFrameworkGUI(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        # Di create_menu_bar(), tambahkan:
        sync_action = QAction('Verify Session Sync', self)
        sync_action.triggered.connect(self.verify_session_sync)
        debug_menu.addAction(sync_action)

        force_sync_action = QAction('Force Sync Sessions', self)  
        force_sync_action.triggered.connect(self.force_sync_sessions)
        debug_menu.addAction(force_sync_action)
